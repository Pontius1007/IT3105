...
class InputRunHandler:
	...
	def evaluate_input(self, u_input):
		...
		if u_input == "dendrogram" or u_input == "dg":
			number_of_cases = int(input("Enter the number of cases you want to use for dendrogram: "))
			self.ann.model.create_dendrogram(number_of_cases)
